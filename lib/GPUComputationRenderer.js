...
export class GPUComputationRenderer {
  constructor(sizeX, sizeY, renderer) {
    ...
    const passThruShader = createShaderMaterial(getPassThroughFragmentShader(), getPassThroughVertexShader(), passThruUniforms);
    ...
    this.addVariable = function (variableName, computeFragmentShader, computeVertexShader, initialValueTexture) {
      const material = this.createShaderMaterial(computeFragmentShader, computeVertexShader);
      const variable = {
        name: variableName,
    ...
    function createShaderMaterial(computeFragmentShader, computeVertexShader, uniforms) {
      uniforms = uniforms || {};
